...
lm_model_btb <- lm(pos_pol_data$Ban.the.Box.Index ~ control_data$macroeconomy + control_data$socioeconomics + control_data$politics)
...
lm_model_rec_clear <- lm(pos_pol_data$Record.Clearing.Index ~ control_data$macroeconomy + control_data$socioeconomics + control_data$politics)
...
lm_model_landc <- lm(pos_pol_data$Licensing.and.Credentialing.Index ~ control_data$macroeconomy + control_data$socioeconomics + control_data$politics)
...
```{r}
# Run a linear model for neg_combo_index vs the three columns of control_data
lm_model_rehab <- lm(pos_pol_data$Certificate.of.Rehabilitation.Index ~ control_data$macroeconomy + control_data$socioeconomics + control_data$politics)
...
```{r}
# Run a linear model for neg_combo_index vs the three columns of control_data
lm_model_liability <- lm(pos_pol_data$Liability.Index ~ control_data$macroeconomy + control_data$socioeconomics + control_data$politics)
